                ...
                <Container maxWidth="lg">
                    ...
                    >
                        ...
                        <Box sx={{ flex: 1 }}>
                            ...
                            <Button variant="contained" sx={{ bgcolor: "#F57C00", color: 'white' }}>
                                CONTACT US
                            </Button>
                        </Box>
                        ...
                        >
                            ...
                            >
                                <Stack spacing={2}>
                                    ...
                                    <TextField fullWidth name="subject" label="Subject" variant="outlined" />
                                    ...
                                    <Button
                                        variant="contained"
                                        sx={{ bgcolor: "#F57C00", px: 4, color: 'white' }}
                                        onClick={() => window.location.href = "mailto:example@example.com?subject=Hello&body=Message"}
                                    >
                                        Send Message
                                    </Button>
                                </Stack>
